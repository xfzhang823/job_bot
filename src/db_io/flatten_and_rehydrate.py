...
def flatten_nested_responsibilities_to_table(
    ...
    Each row includes:
        ...
        - optimized_text: The aligned (edited) text

    Args:
        model (NestedResponsibilities): A validated model instance.
...
def rehydrate_nested_responsibilities_from_table(
    ...
    Args:
        df (pd.DataFrame):
            ...
            with 'url', 'responsibility_key', 'requirement_key', and 'optimized_text'.
