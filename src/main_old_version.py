...
def run_pipeline_2b():
    ...
    mapping_file_path = ITERATE_0_OPENAI_DIR / mapping_file_name
...
def run_pipeline_3a():
    """Pipeline to create/upsert the mapping file."""
    pipe_num = "3a"
    """
    Pipeline for creating/updating the mapping file.
    """
...
def run_pipeline_3b():
    ...
    mapping_file_curr_path = ITERATE_1_OPENAI_DIR / mapping_file_name
    mapping_file_prev_path = ITERATE_0_OPENAI_DIR / mapping_file_name
