...
# Todo: stage is str. for now; later need to figure out a more integrated solution for
# Todo: both filing system and db processes.
PIPELINE_CONFIG = {
    "1": {
        "stage": "preprocessing",  # Pipeline stage: Preprocessing
    ...
    "1_async": {
        "stage": "preprocessing",  # Async preprocessing stage
    ...
    "2a": {
        "stage": "staging",  # Evaluation stage
