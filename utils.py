...
from prompts import CLEAN_JOB_PAGE_PROMPT, CONVERT_JOB_POSTING_TO_JSON_PROMPT
...
# summarized_news = fetch_and_summarize_news(company_name, news_api_key, openai_api_key)
